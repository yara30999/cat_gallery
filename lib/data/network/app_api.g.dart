...
class _AppServiceClient implements AppServiceClient {
  ...
  Future<List<ImageAnalysisResponse>> getImageAnalysis(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<ImageAnalysisResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<ImageAnalysisResponse> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
              ImageAnalysisResponse.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
