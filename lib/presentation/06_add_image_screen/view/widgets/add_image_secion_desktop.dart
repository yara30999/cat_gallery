...
import '../../../02_home_screen/view/01_main_breeds/view_model/cubit/cat_breeds_cubit.dart';
...
class AddImageSectionDesktop extends StatefulWidget {
  const AddImageSectionDesktop({super.key});

  @override
  State<AddImageSectionDesktop> createState() => _AddImageSectionDesktopState();
}

class _AddImageSectionDesktopState extends State<AddImageSectionDesktop> {
                ...
                BlocBuilder<CatBreedsCubit, CatBreedsState>(
                  builder: (context, state) {
                    if (state is CatBreedsSuccess) {
                      return PickBreed(
                        breeds: BlocProvider.of<CatBreedsCubit>(context)
                            .catBreedsList,
                      );
                    }
                    return PickBreed(
