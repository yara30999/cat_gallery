...
class RegisterViewBodyTablet extends StatefulWidget {
  const RegisterViewBodyTablet({super.key});

  @override
  State<RegisterViewBodyTablet> createState() => _RegisterViewBodyTabletState();
}

class _RegisterViewBodyTabletState extends State<RegisterViewBodyTablet> {
  String? name;
  String? email;
  String? password;
