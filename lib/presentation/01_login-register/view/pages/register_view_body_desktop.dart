...
class RegisterViewBodyDesktop extends StatefulWidget {
  const RegisterViewBodyDesktop({super.key});

  @override
  State<RegisterViewBodyDesktop> createState() =>
      _RegisterViewBodyDesktopState();
}

class _RegisterViewBodyDesktopState extends State<RegisterViewBodyDesktop> {
  String? name;
  String? email;
  String? password;
