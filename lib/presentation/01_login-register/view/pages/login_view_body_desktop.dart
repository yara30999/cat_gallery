...
class LoginViewBodyDesktop extends StatefulWidget {
  const LoginViewBodyDesktop({super.key});

  @override
  State<LoginViewBodyDesktop> createState() => _LoginViewBodyDesktopState();
}

class _LoginViewBodyDesktopState extends State<LoginViewBodyDesktop> {
  String? email;
  String? password;
  bool isObscure = true;
